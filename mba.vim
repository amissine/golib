...
silent only
silent tabonly
cd ~/go/src/github.com/amissine/golib
...
argglobal
%argdel
$argadd statemachine/statemachine_test.go
set stal=2
tabnew
tabnew
tabnew
...
tabnew
tabrewind
edit statemachine/statemachine.go
...
silent! normal! zE
let s:l = 66 - ((37 * winheight(0) + 23) / 46)
...
normal! 0
tabnext
edit statemachine/basic_test.go
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
101
normal! zo
let s:l = 118 - ((66 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
normal! 03|
tabnext
edit statemachine/statemachine_test.go
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 5
set stal=1
badd +1 statemachine/statemachine.go
badd +13 statemachine/statemachine_test.go
badd +6 statemachine/basic_test.go
badd +1 statemachine/basic.go
badd +0 main.go
badd +1 basic/basic.go
badd +185 /usr/local/go/src/runtime/extern.go
badd +546 /usr/local/go/src/runtime/symtab.go
badd +1 basic.go
badd +0 main_test.go
